...
const UI_Changelog = {
  updates: [
    ...
    },
    {
      ...
      <ul class="guia-tl-list">
        <li><strong>Rota mais barata, misturando as três fontes.</strong>  Você diz quantas peças quer e de qual raridade, e ele monta o caminho: usa o que já tem no estoque, funde o que compensa fundir e compra o resto pronto.  Num caso real, pra 20 Rare Wire: usa as que já tem, funde 4 a partir de 3.300 Common parados no inventário e compra as 15 restantes, saindo mais barato que comprar as 20 prontas.  Antes ele só sabia comparar "fundir tudo" contra "comprar tudo", nunca dividir.</li>
        <li><strong>Mostra o quanto as outras opções perderiam, mesmo quando a rota escolhida já É uma delas.</strong>  Sem estoque nenhum, pedir 22 Legendary Fan cai direto em "compre pronto" e a comparação sumia, porque a rota escolhida e "comprar tudo" eram a mesma coisa.  Agora aparece o outro lado: nesse caso, fundir do zero custaria <strong>216,70 RLT</strong> contra <strong>111,59</strong> comprando, economia de 105 RLT que antes ficava escondida.</li>
        <li><strong>Lê seu estoque real.</strong>  Antes você digitava uma raridade e uma quantidade só, como se todas as suas peças estivessem no mesmo nível.  Agora ele usa o estoque colado na aba Inventário, em todas as raridades de uma vez, e conta o que você já tem como custo zero.</li>
        <li><strong>🚨 Taxas de fusão desatualizadas: o jogo mudou os valores em algum momento e a gente não sabe quando.</strong>  As quatro estavam mais altas do que a RollerCoin cobra hoje: Common→Uncommon estava em 0,005 e é <strong>0,002</strong>; Uncommon→Rare estava em 0,105 e é <strong>0,05</strong>; Rare→Epic estava em 1,1025 e é <strong>0,75</strong>; Epic→Legendary estava em 5,7881 e é <strong>1,6</strong>.  Conferidas contra a tela de merge do jogo em 27/08/2026.  As quantidades (50, 20, 10, 5) continuam as mesmas.  Isso muda conclusões: fundir 5 Legendary Hashboard a partir de 250.000 Common aparecia como 107,75 RLT, pior que comprar as 5 prontas por 65,89, quando com a taxa atual custa <strong>49,25 RLT</strong> e é a opção mais barata.  O Plano de Merges usa a mesma tabela, então o custo de peças de lá também estava com a taxa antiga.</li>
        <li><strong>Essas taxas agora vêm de um lugar só.</strong>  O número estava repetido em três pontos do código, que foi o que deixou o erro passar tanto tempo.  A tabela mostrada na tela passou a ser gerada a partir da mesma fonte que os cálculos usam.  Ela também avisa que os valores são <strong>sem desconto</strong>: se a sua conta tem desconto de merge, o jogo mostra o valor riscado e você paga menos que o calculado aqui.</li>
        <li><strong>Saiu um conselho que estava errado.</strong>  A aba afirmava que "merge sempre compensa, é muito mais barato que comprar no marketplace".  Isso era texto fixo, nunca foi calculado, e não vale sempre: sem matéria-prima no estoque, comprar 5 Legendary Hashboard prontas ainda sai mais barato que qualquer rota de fusão.  Agora cada resultado compara com o preço real em vez de afirmar.</li>
        <li><strong>RST Sell voltou a dar resultado.</strong>  A aba mostrava <strong>0,0000 RLT</strong> em tudo: ela calculava "peças da caixa × preço da Common", e a Common perdeu o preço quando saiu do marketplace, então multiplicava por nada.  Agora ela mostra a conta que faz sentido hoje: até que raridade compensa fundir antes de anunciar.  Com 14.000 RST, por exemplo, a melhor saída é caixa de Wire, fundir até Uncommon e vender, sobrando <strong>+11,55 RLT</strong> depois das taxas de fusão e da comissão.  Fundir além disso rende menos, porque cada degrau cobra mais taxa do que acrescenta em preço.</li>
        <li><strong>Uma aba a menos.</strong>  A "vs Market" respondia quase a mesma pergunta que a Parts, e o campo pra colar preços do marketplace já vive na aba <strong>Inventário</strong>, então ela só duplicava as duas coisas.</li>
      </ul>`
    },
    {
      date: '27 Ago 2026', time: '20:31', tag: 'new', label: 'NOVO',
      html: `<strong>Plano de Merges: gere um plano completo a partir de quanto RLT (e RST) você tem.</strong>  Antes você descia a lista inteira contando na mão até onde o orçamento dava, e o custo mostrado era só a taxa de fusão da miner.  Agora é um plano de ponta a ponta: taxa da miner, custo das peças que faltam, e o que fazer quando falta matéria-prima.
      <ul class="guia-tl-list">
        <li><strong>💰 Quanto RLT você tem? 🪙 E de RST?</strong>: gera o plano automaticamente.  Pra cada miner, escolhe entre fundir só o próximo passo ou a cadeia completa (até onde as cópias que já tem permitem), o que render melhor impacto real por RLT, e enche o orçamento nessa ordem.  Só entram merges 🟢 Ótimo ou 🟡 Ok.</li>
        <li><strong>Piso de uso real:</strong> merge cujo impacto fica abaixo do que sua sala já sustenta fica de fora, porque não compete de verdade por espaço.  O piso ignora miners de "lastro" (aquelas que você instala só pra ocupar célula sem empurrar seu poder e evitar subir de liga sem querer), pois sem isso uma miner de lastro quase zerava o piso e deixava passar merge fraco demais.</li>
        <li><strong>Custo real das peças:</strong> pra cada peça que falta, o app desce a cadeia (Rare ← Uncommon ← Common) e calcula quantas fusões e quanto de RLT custaria produzi-la a partir do que você já tem.  O estoque é compartilhado entre os merges do plano: o segundo já enxerga o que o primeiro gastou, então dois merges que precisam da mesma peça não aparecem os dois como viáveis quando só um seria.</li>
        <li><strong>Matéria-prima em Common equivalente:</strong> cada card agora mostra de cara "quantas peças Common eu preciso pra fazer isso do começo ao fim", somando toda a cadeia (não só o 1º passo) e convertendo raridade alta pro equivalente em Common (1 Rare = 1.000 Common, 1 Epic = 10.000).  Sem isso um card podia pedir "70 peças" quando o consumo real, escondido nas fusões seguintes, era 4.340.</li>
        <li><strong>Fundir ou comprar pronta:</strong> peça a peça, o plano compara produzir por fusão contra comprar no marketplace, e fica com o mais barato, mostrando a alternativa descartada ao lado.  A RollerCoin tirou peça Common do marketplace, então essa comparação nunca entra pra Common, só pra Rare pra cima.  Só compara quando você informa os preços, num campo novo na aba Inventário, pra não recomendar compra com número chutado.</li>
        <li><strong>RST pra completar peça que falta:</strong> quando o estoque de Common acaba no meio de uma fusão, o plano compra Parts Case (100 RST, mínimo 250 peças, medido por amostra real de abertura) e continua.  Corrigido no caminho: ter RST disponível podia deixar o plano <em>pior</em> (um caso real caiu de 30 merges/+256 Eh/s pra 25/+188 Eh/s com 11.000 RST), porque usar RST consome estoque que outros merges do plano aproveitariam.  Agora o plano roda com e sem RST e fica sempre com o melhor resultado.</li>
        <li><strong>Miner instalada como ingrediente:</strong> merge que consome miner da sala (não só do inventário) agora desconta certo quantas cópias saem de fato, não sempre 1, evitando tanto perder poder à toa (desinstalar quando o inventário já cobria) quanto superestimar o ganho (quando precisava tirar mais de uma da sala).</li>
        <li><strong>Rode o Auto-Otimizar antes de decidir os merges.</strong>  Sem a sala otimizada, o plano compara os merges contra miners fracas que ainda ocupam vaga, e parte do ganho mostrado some assim que você otimiza de verdade.  Um banner leva direto pro SmartRoom.</li>
        <li><strong>Tela reorganizada</strong> em três blocos: 1) quanto você tem, 2) seu plano, 3) explorar todos os merges (fechado por padrão, com a lista completa, ordenação e filtros lá dentro).  Cada item do plano mostra a imagem da miner, os níveis que você já tem, e abre como accordion agrupado por peça (não mais uma lista corrida misturando os passos de peças diferentes).</li>
        <li><strong>Corrigido no caminho:</strong> o cálculo de impacto real não somava bônus de set (só coleção e rack), o que fazia peça de set essencial parecer pouco importante.  E os valores de caixa de RST estavam desatualizados no app inteiro (40 RST / 175 peças); os corretos, 100 RST / 250 peças, foram ajustados também na aba RST Sell.</li>
      </ul>`
    },
    {
